...
public:
	...
	void DrawModel(int indices, Shader& shaderProg, glm::mat4 model, unsigned int vbo, unsigned int ibo, unsigned int posAtt, unsigned int colAtt, unsigned int normalAtt, unsigned int uvAtt, bool& wireframeActive);
